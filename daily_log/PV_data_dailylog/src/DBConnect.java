...
public class DBConnect {
	...
	public void writeData(double Wtot, double Wtoday, int Pmax, int Pavg) {
		try {
...
/*			String query = "select * from statistik_daily where id=1";
			...
			String query = "INSERT into statistik_daily (Wtot, Wtoday, Pmax, Pavg) values (" + Wtot + "," + Wtoday + "," + Pmax + "," + Pavg + ")";
			st.execute(query);
	...
	public void readData(int[] p) {
		...
		try {
			...
			Format formatter2 = new SimpleDateFormat("YYMM");
